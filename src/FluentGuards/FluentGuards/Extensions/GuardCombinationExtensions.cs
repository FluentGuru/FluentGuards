...
namespace FluentGuards
{
    public static class GuardCombinationExtensions
    {
        ...
        public static IAsyncCombinedGuard<T> Combine<T>(this IAsyncGuard<T> guard, Func<T, IAsyncGuard<T>> predicate, GuardCombinationTypes type)
        ...
        public static IAsyncCombinedGuard<T> And<T>(this IAsyncGuard<T> guard, Func<T, IAsyncGuard<T>> predicate)
            => guard.Combine(predicate, GuardCombinationTypes.And);

        public static ICombinedGuard<T> Or<T>(this IGuard<T> guard, Func<T, IAsyncGuard<T>> predicate)
            => guard.Combine(predicate, GuardCombinationTypes.Or);

        public static IAsyncCombinedGuard<T> Or<T>(this IAsyncGuard<T> guard, Func<T, IAsyncGuard<T>> predicate)
            => guard.Combine(predicate, GuardCombinationTypes.Or);
    }
}
